...
// Sample elderly care services data
const elderlyCareServices = [
    {
        id: 1,
        title: "Companionship & Mental Support",
        description:
            "Friendly interaction, emotional support, and companionship to improve overall well-being.",
        price: "₹1,200/day",
        rating: 4.8,
        features: [
            "Daily Conversations",
    ...
    },
    {
        ...
        description:
            "Support with daily tasks like bathing, dressing, and medication reminders.",
        price: "₹1,800/day",
        rating: 4.9,
        features: [
            "Meal Preparation",
    ...
    },
    {
        ...
        description:
            "Regular check-ins on vitals and chronic condition management.",
        price: "₹1,400/day",
        rating: 4.7,
        features: [
    ...
    },
    {
        ...
        description:
            "Professional support for elderly patients recovering at home after hospital stays.",
        price: "₹2,200/day",
        rating: 4.8,
        features: [
            "Wound Dressing",
...
export default function ElderlyCareDetail() {
    const { id } = useParams();
